    ...
    <div className={styles.navbar}>
      <div className={styles.right}>
        ...
        <div className={styles.navLink}>
          ...
          <Link to="/ryde" className={styles.removeunderline}>
            <p className={styles.white}>rYde</p>
          </Link>
          <Link to="/redrail" className={styles.removeunderline}>
            <p className={styles.white}>redRail</p>
          </Link>
        </div>
      </div>
